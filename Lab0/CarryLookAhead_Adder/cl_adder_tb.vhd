...
entity cl_adder_tb is
end cl_adder_tb;

architecture arch of cl_adder_tb is
  component cl_adder
    generic (
      n : integer := 8
    );
...
begin
  uut: cl_adder port map (a => a, b => b,sum => sum, cout=> cout);
  process
    variable ref : integer;
    variable errors : integer := 0;
  begin
    report "Testing cl_adder at " & real'image(TARGET_FREQ / 1.0e6) & " MHz (" &
